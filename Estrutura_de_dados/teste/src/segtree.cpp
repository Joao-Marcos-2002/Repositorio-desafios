...
// Função para combinar dois objetos Segtree
...
// // AssociacaoTransformacao
// Matrix2x2 Segtree::associarTransformacao(Matrix2x2 a, Matrix2x2 b) {
//     unsigned long int num = 10000000000;

//     return Matrix2x2 {
//         (a.m11 * b.m11 + a.m12 * b.m21) % num,
//         (a.m11 * b.m12 + a.m12 * b.m22) % num,
//         (a.m11 * b.m11 + a.m22 * b.m21) % num,
//         (a.m21 * b.m12 + a.m22 * b.m22) % num
//     };
// }
...
// Matrix2x2 Segtree::update(int i, int x, int p, int l, int r) {
//     if (i < l || r < i) return vet[p];
//     if (l == r) return vet[p] = {x, 1};

//     int m = (l + r) / 2;
//     return vet[p] = combina(update(i, x, 2*p, l, m),
//     update(i, x, 2*p+1, m+1,r));
// }
